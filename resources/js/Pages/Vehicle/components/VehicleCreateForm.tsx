...
import { z } from 'zod';
import { vehicleCreateFormSchema } from '../models/schema';

interface IVehicleCreateForm {
  onSubmit: (data: IRootVehicle) => void;
  onCancel: () => void;
  isLoading?: boolean;
}

type FormSchema = z.infer<typeof vehicleCreateFormSchema>;
...
export function VehicleCreateForm({
  ...
  const handleSubmit = (values: FormSchema) => {
    ...
    onSubmit(payload as unknown as IRootVehicle);
  };
